import { BODY_FAT_CATEGORIES } from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/constants';
import { EGender } from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/enums';
import { IBodyFatValues } from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/interfaces';
import { calculateBMI } from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/helpers';
