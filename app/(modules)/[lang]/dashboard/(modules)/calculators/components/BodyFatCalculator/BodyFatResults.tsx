...
import BodyFatTooltipTable from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/components/BodyFatCalculator/BodyFatTooltipTable';
import { Card } from '@/app/components/ui/card';
import { IBodyFatResults } from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/interfaces';
