...
import CalorieTableRow from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/components/CalorieCalculator/CalorieTableRow';
import { ICalorieResultsProps } from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/components/CalorieCalculator/CalorieResults';
