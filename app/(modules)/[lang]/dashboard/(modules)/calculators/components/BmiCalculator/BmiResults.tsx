...
import BmiTooltipTable from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/components/BmiCalculator/BmiTooltipTable';
import { Card } from '@/app/components/ui/card';
import { IBmiResults } from '@/app/(modules)/[lang]/dashboard/(modules)/calculators/interfaces';
