...
import EditMealDialog from '@/app/(modules)/dashboard/(modules)/meals/components/EditMealDialog';
...
import { deleteMeal } from '@/app/(modules)/dashboard/(modules)/meals/actions';
