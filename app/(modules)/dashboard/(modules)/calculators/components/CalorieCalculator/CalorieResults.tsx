...
import GainResults from '@/app/(modules)/dashboard/(modules)/calculators/components/CalorieCalculator/GainResults';
import { ICalorieResults } from '@/app/(modules)/dashboard/(modules)/calculators/interfaces';
import LossResults from '@/app/(modules)/dashboard/(modules)/calculators/components/CalorieCalculator/LossResults';
