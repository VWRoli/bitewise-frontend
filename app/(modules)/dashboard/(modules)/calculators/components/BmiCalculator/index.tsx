...
import BmiForm from '@/app/(modules)/dashboard/(modules)/calculators/components/BmiCalculator/BmiForm';
import BmiResults from '@/app/(modules)/dashboard/(modules)/calculators/components/BmiCalculator/BmiResults';
