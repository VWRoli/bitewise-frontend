import { BODY_FAT_CATEGORIES } from '@/app/(modules)/dashboard/(modules)/calculators/constants';
...
import { calculateBMI } from '@/app/(modules)/dashboard/(modules)/calculators/helpers';
