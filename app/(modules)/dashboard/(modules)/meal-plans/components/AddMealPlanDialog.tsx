...
import {
  ICreateMealPlan,
  IMealPlan,
} from '@/app/(modules)/dashboard/(modules)/meal-plans/interfaces';
import React, { useState } from 'react';
import {
  TMealPlanSchema,
  mealPlanSchema,
} from '@/app/(modules)/dashboard/(modules)/meal-plans/validations';
import {
  createMealPlan,
  updateMealPlan,
} from '@/app/(modules)/dashboard/(modules)/meal-plans/actions';
