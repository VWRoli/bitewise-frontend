...
const config: Config = {
  ...
  theme: {
  	extend: {
  		...
  		boxShadow: {
  			'table-header': '0rem 0.25rem 1.25rem 0rem rgba(0, 0, 0, 0.14),0rem 0.4375rem 0.625rem -0.3125rem rgba(0, 187, 212, 0.4)',
  			'statistics-card': '0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1),0rem 0.125rem 0.25rem -0.0625rem rgba(0, 0, 0, 0.06)'
  		},
  		borderRadius: {
  			lg: 'var(--radius)',
